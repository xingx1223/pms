...
<c:forEach items="${list}" var="analysis" varStatus="index">
    <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
        ...
        <td>
            ...
            <fmt:formatDate value="${analysis.addtime}" pattern="yyyy-MM-dd"/>

        </td>
        <td>
            <fmt:formatDate value="${analysis.updatetime}" pattern="yyyy-MM-dd"/>

        </td>
        <td><a href="${pageContext.request.contextPath}/analysis/selectAnaById/${analysis.id}">编辑</a> | <a href="${pageContext.request.contextPath}/analysis/selectById/${analysis.id}">查看详情</a></td>
    </tr>
</c:forEach>
