...
<LINK href="${pageContext.request.contextPath}/css1.css" type=text/css rel=stylesheet>
...
<script type="text/javascript">
	...
	<form id="form" action="${pageContext.request.contextPath}/emp/login" method="post">
	<DIV>
			...
			<TBODY>
				...
				<TR>
					...
					<TD><input title=登录项目平台管理系统 type=image height=48 alt=""
						width=86 src="${pageContext.request.contextPath}/images/crm_17.gif" name="image" onclick="login()">
					</TD>
