...
<li><a href='${pageContext.request.contextPath}/archives/selectAllArchives' target='main'>档案管理</a> </li>
...
<li><a href='${pageContext.request.contextPath}/bx/list' target='main'>我的报销</a> </li>
	<li><a href='fatie.jsp' target='main'>发帖页面</a> </li>
</ul></dd></dl>
...
<li><a href='${pageContext.request.contextPath}/cus/list' target='main'>客户信息</a> </li>
</ul></dd></dl>
