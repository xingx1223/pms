...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/analysis/addAnalysis" method="post">
...
<tr>
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="id" id="proList" onchange="parsePname(this.value)">
			<option>--请选择--</option>
		</select>
	</td>
</tr>
