...
<body leftmargin="8" topmargin="8" background='${pageContext.request.contextPath}/skin/images/frame/wbg.gif'>
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/cus/update" method="post">
