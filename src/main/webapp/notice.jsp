...
<script type="application/javascript">
		...
		$.ajax({
			...
			success:function(resultData){
				$(resultData).each(function(index,item){
					...
					tr+="<td>"+di+"</td>"
					+"<td><a href='javascript:deleteById("+item.nid+")'>删除</a> |<a href='customer-edit.jsp'>编辑</a> | <a href='customer-look.jsp'>查看详情</a></td> </tr>";
					$("#tr2").after(tr);
				});
			},
			error:function(){
	...
	function deleteById(nid) {
		$.ajax({
			type:"post",
			url:"${pageContext.request.contextPath}/notice/deleteById",
			data:{"_method":"delete","nid":nid},
